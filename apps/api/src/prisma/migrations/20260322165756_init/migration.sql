...
-- CreateIndex
CREATE INDEX "categories_organization_id_created_at_id_idx" ON "categories"("organization_id", "created_at", "id");
...
-- CreateIndex
CREATE INDEX "stock_movements_organization_id_created_at_id_idx" ON "stock_movements"("organization_id", "created_at", "id");
